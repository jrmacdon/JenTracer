...
public class VectorTests {
    ...
    public static void main(String[] args) {
        ...
        myScene.put(new Sphere3(new Vector3 (0,1,0),2, new Vector3 (0.2, 0.5, 0.1), 0.4));
        myScene.put(new Sphere3(new Vector3 (-3,3.5,0.7),0.1, new Vector3 (0.1, 0.2, 0.4), 0.0));
        myScene.put(new Sphere3(new Vector3 (3,0,0),2, new Vector3 (0.8, 0.2, 0.2), 0.0));
        myScene.put(new Sphere3(new Vector3 (0,6,-5),1, new Vector3 (0.5, 0.2, 0.2), 0.0));
        myScene.put(new Sphere3(new Vector3 (-6,3,-2),0.5, new Vector3 (0.1, 0.3, 0.2), 0.0));
        myScene.put(new Sphere3(new Vector3 (8,1,-20),8, new Vector3 (0.3, 0.2, 0.7), 0.0));
        myScene.put(new Sphere3(new Vector3 (-2,1.5,8),0.3, new Vector3(), 0.5));
        myScene.put(new Plane3(new Vector3(0,0,0), new Vector3(0,1,0), new Vector3(0.2, 0.2, 1.0), 0.2));
//        myScene.put(new Plane3(new Vector3(-40,0,0), new Vector3(1,0,0), new Vector3(0.8, 0.5, 0.1), 0.0));
//        myScene.put(new Plane3(new Vector3(0,40,0), new Vector3(0,-1,0), new Vector3(0.9, 0.9, 0.9), 0.0));
//        myScene.put(new Plane3(new Vector3(0,0,-200), new Vector3(0,0,1), new Vector3(0.7, 0.5, 0.9), 0.0));
//        myScene.put(new Plane3(new Vector3(12,0,0), new Vector3(-3,0,0), new Vector3(0.8, 0.5, 0.8), 0.5));
...
//        myScene.put(new PointLight(-10,5,-100, 5 , 5, 35));
        ...
        for (int i = 0; i < screenHeight; i++) {
            for (int j = 0; j < screenWidth; j++) {
                ...
                IntersectResult finalResult = myScene.calcReflectionColor(test, 10);
